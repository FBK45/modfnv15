...
app.get('/content/api/pages/fortnite-game', async (req, res) => {
            ...
            emergencynotices: [
                {
                    ...
                    title: 'ModFN',
                    body: 'Made by GGDev and FNLeaks!',
                }
            ]
        },
    ...
    data.data.battleroyalenewsv2 = {
        news: {
            motds: [{
                entryType: 'Website',
                image: `https://cdn.discordapp.com/attachments/898163750287331358/920381230401347696/modfn.png`,
                tileImage: `https://cdn.discordapp.com/attachments/898163750287331358/920381230401347696/modfn.png`,
                videoMute: false,
                hidden: false,
